						...
						<div class="col-lg-3 col-md-3 col-sm-12">
										<div class="row main_login_form">
											...
											<?php
												...
												<?php if($featuredExhibitor['biddingStatus'] == "Running") { ?>  
												...
												<?php if($featuredExhibitor['biddingStatus'] == "Closed") { ?>
													<img id="bidClosedImg" src="assets/img/bidClosed.jpg" height="35" style="display: none;" />
												<?php } ?>
											...
											<?php if($featuredExhibitor['biddingStatus'] == "Opening Soon") { ?>
										...
										<div class="countdown text-center">
											<h3 id="bidTitleStatus">Limited Time Only!</h3>											
											<span id="clock"></span>
											<div id="ribbon"></div>
											<br>
										</div>
...
// });
			...
			var currentDateTime =
				...
				if(auctionEndDate > auctionStartDate && auctionEndDate > nowDateTime) {
					ribbon = 'Bidding Running';
					allowBid = 1;
					bidTitleStatus = "Bidding will expire in";
				...
				if(auctionEndDate < nowDateTime) {
					...
					allowBid = 0;
					bidTitleStatus = "Sorry, BID Expired!!";
					auctionTime = auctionEndDate;
				...
				if(auctionStartDate > nowDateTime) {
					...
					allowBid = 0;
					bidTitleStatus = "Wait! Auction will start in";
				...
				$('#bidTitleStatus').html(bidTitleStatus);
