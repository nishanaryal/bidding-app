...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $Server="localhost";
         ...
         $query="insert into User(Name,UserName,Password,Email,Phone,Gender,DOB,Address,Image) values('$name','$uname','$Password','$email','$phone','$gender','$dob','$address','$destination')";
