    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                ...
                <input type="text" class="form-control" name="uname" placeholder="Enter User Name" value="silverlun">
                <input type="password" class="form-control" name="Pass" placeholder="Password" value="Nepal@123">
