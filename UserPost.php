...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    // echo $description;
     ...
     $query="insert into Product(ProductName,categoryName,UserName,Price,Description,ProductStatus,Quantity,StartDate,EndDate,Buyer,Image)      values('$name','$category','$uname','$price','$description','$ProductStatus','$Quantity','$sdate','$edate','Null','$destination')";
      ...
      <form action="" method="POST" enctype="multipart/form-data" role="form" name="BidForm">
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
              <label class="control-label" for="signupName">Product category</label>
