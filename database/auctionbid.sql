...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2022 at 01:24 PM
...
(10, 3, 1, 3466000, '2022-04-12 09:13:00', 0),
(11, 3, 1, 3466300, '2022-04-11 14:00:00', 0),
(12, 3, 1, 3467300, '2022-04-13 08:28:00', 0),
(13, 1, 1, 3467300, '2022-04-13 08:29:07', 0),
(14, 1, 1, 3467300, '2022-04-12 08:00:00', 1),
(15, 1, 2, 8301000, '2022-04-14 06:41:00', 0);
...
INSERT INTO `products` (`productid`, `name`, `photo`, `slug`, `shortdescription`, `description`, `features`, `additional_info`, `exhibitorid`, `categoryid`, `isActive`, `isFeatured`, `allowBidding`, `auction_start`, `auction_end`, `base_price`, `addedOn`, `modifiedOn`) VALUES
(1, 'Mint condition 2018 Hyundai Tucson Diesel AWD in Automatic Transmission', '1649641321.jpg', 'mint-condition-2018-hyundai-tucson-diesel-AWD-in-automatic-transmission', '                                                                                                    ', '                                                                                                                                                                                                                                                                                                Mint condition, 2018 Hyundai Tucson Diesel AWD in Automatic Transmission. Only been driven for 28,000 kms, with Full Company Service History.\r\nThis vehicles comes with Dual Airbags, Push Button Start                                                                                                                                                                                                                                                                                                ', 'features', '                                                                                                                                                                                                                                                message\r\nmessage\r\nmessage\r\nmessage\r\nmessage                                                                                                                                                                                                                                                ', 1, 1, 1, 1, 'yes', '2022-04-09 08:20:00', '2022-04-22 08:20:00', 8300000, '2022-04-14 11:18:10', '2022-04-14 13:20:11'),
(2, 'SEDAN CAR', '1649601607.jpg', 'low-run-2018-hyundai-tucson-crdi-at-wfull-service-history', '                                                                                                Only', '                                                                                                Mint condition, 2018 Hyundai Tucson Diesel AWD in Automatic Transmission. Only been driven for 28,000 kms, with Full Company Service History.\r\nThis vehicles comes with Dual Airbags, Push Button Start                                                                                                ', 'features', '                                                message\r\nmessage\r\nmessage\r\nmessage\r\nmessage                                                ', 1, 1, 1, 1, 'yes', '2022-04-09 08:20:00', '2022-04-22 08:20:00', 8300000, '2022-04-14 11:18:10', '0000-00-00 00:00:00'),
...
CREATE TABLE `user` (
  ...
  `isKYCVerified` tinyint(4) NOT NULL,
...
INSERT INTO `user` (`userid`, `name`, `username`, `password`, `email`, `phone`, `gender`, `dob`, `address`, `user_photo`, `user_role`, `isKYCVerified`, `isActive`, `addedOn`, `modifiedOn`) VALUES
(1, 'Super Admin', 'superadmin', 'Nepal@123', 'superadmin@gmail.com', '9802301060', 'Female', '2046-09-09', 'Sanepa Kathmandu', '1649637421.jpg', 'Super Admin', 0, 0, '2022-04-13 02:36:26', '0000-00-00 00:00:00'),
(2, 'Early Bird', 'silverlun', 'Nepal@123', 'silverlun.03@gmail.com', '9849010101', 'Female', '2048-01-21', 'Sanepa 32 Kathmandu', '1649932423.jpg', 'Seller', 0, 1, '2022-04-14 10:09:01', '2022-04-14 12:34:12'),
(3, 'Sandhya Khanal', 'user3', 'Nepal@123', 'user3@gmail.com', '9851123456', 'Male', '2045-09-09', 'Ncell Chowk, Buddhanilkantha Kathmandu', '1649639730.jpg', 'Seller', 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(4, 'General / Buyer', 'general', 'Nepal@123', 'general@gmail.com', '9851123456', 'Male', '2045-09-09', 'Ncell Chowk, Buddhanilkantha Kathmandu', '1649637505.jpg', 'General / Buyer', 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
ALTER TABLE `exhibitor_profile`
  MODIFY `exhibitorid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
