...
<script>
  ...
  function validform()
  {
   ...
   {
      alert("Please select Product category"); // prompt user
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  else
   {
    ...
    else
    {
    	...
    	$query="select * from Product where UserName='$uname' and categoryName='$category'";
        $Rows=mysqli_query($connection,$query);
   ...
   {
   	echo "<script> window.alert('You Have Not Any Post Yet On this category');</script>";
   }
...
<nav class="navbar navbar-inverse">
  ...
  <p id="heading">Select Product category</p>
<center>
