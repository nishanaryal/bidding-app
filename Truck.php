...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active" class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>&nbsp&nbspTruck</b><span class="caret"></span></a>
...
<?php
   $Server="localhost";
    ...
    $query="select * from product where categoryName='Truck' and ProductStatus='No' ";
    $Result=mysqli_query($connection,$query);
    $break=0;
